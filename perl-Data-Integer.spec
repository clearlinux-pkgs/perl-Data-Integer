...
Version  : 0.007
Release  : 30
URL      : https://cpan.metacpan.org/authors/id/R/RR/RRWO/Data-Integer-0.007.tar.gz
Source0  : https://cpan.metacpan.org/authors/id/R/RR/RRWO/Data-Integer-0.007.tar.gz
...
%prep
%setup -q -n Data-Integer-0.007
cd %{_builddir}
tar xf %{_sourcedir}/libdata-integer-perl_0.006-1.debian.tar.xz
cd %{_builddir}/Data-Integer-0.007
mkdir -p deblicense/
cp -r %{_builddir}/debian/. %{_builddir}/Data-Integer-0.007/deblicense/
